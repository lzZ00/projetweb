<div class="col-md-10 col-md-offset-1">
    ...
    <table class="table table-hover table-bordered">
            ...
            <td>
                <select class="form-control" name="tva_tx">
                    ...
                    <?php foreach ($tva_available as $un_tva): ?>
                        <option value="<?php echo $un_tva['taux']?>"><?php echo $un_tva['taux']?>%</option>
                    <?php endforeach; ?>
                </select>
            </td>
            <td>
        ...
        <tr class="sku">
            ...
            <td colspan="6">
                <input type="text" size="5" name="pack" class="form-control"/>
            </td>
        </tr>
        <tr class="sku">
            <td>
            ...
            <td colspan="6">
                <input type="text" size="5" name="box" class="form-control"/>
            </td>
        </tr>
        <tr class="sku">
            <td>
            ...
            <td>
                <input type="text" name="barcode_bigbox" class="form-control"/>
            </td>
            <td>
            ...
            <td colspan="6">
                <input type="text" size="5" name="bigbox" class="form-control"/>
            </td>
        </tr>
